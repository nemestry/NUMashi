# DETashi - детектирование цифр на жд вагонах
import cv2
import SETashi
import tensorflow as tf
import numpy as np

from ext.FROZashi import load_frozen_graph


class RTKashiDetect(object):
    def __init__(self,config):        
        self.config = config                
        self.detect_function = load_frozen_graph(SETashi.RTKashiDetectModelPath)
